...
public interface VertexInterface<T> {
	...
	/** Connects this vertex and a given vertex with a weighted edge. The two vertices cannot be the same, 
	 * 		and must not already have this edge between them. 
	 * 		In a directed graph, the edge points towards the given vertex.
	...
	/** Connects this vertex and a given vertex with an unweighted edge. The two vertices cannot be the same, 
	 * 		and must not already have this edge between them. 
	 * 		In a directed graph, the edge points towards the given vertex.
	 * @param endVertex A vertex in the graph that ends the edge.
	 * @return True if the edge is added, or false if not. */
	...
	/** Removes the edge of the vertex with its neighbor.
	 * @param neighbor The end vertex that will lose its connection with the vertex.
	...
	/** Gets the weight of the edge with the specified neighbor.
